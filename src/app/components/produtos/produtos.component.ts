...
export class ProdutosComponent implements OnInit {
    ...
    readonly FILTRO_STATUS_OPTIONS = [
        { label: 'produtos.filters.status_all', value: 'todos' },
        { label: 'produtos.status.active', value: 'ativo' },
        { label: 'produtos.status.paused', value: 'pausado' },
        { label: 'produtos.status.interrupted', value: 'interrompido' },
    ];
    ...
    readonly MODO_ENVIO_OPTIONS = [
        { label: 'produtos.kit.shipping_combined', value: 'combinado' },
        { label: 'produtos.kit.shipping_random', value: 'aleatorio' },
    ];
    ...
    statusLabel(status: StatusProduto): string {
        return { ativo: 'produtos.status.active', pausado: 'produtos.status.paused', interrompido: 'produtos.status.interrupted' }[status];
    }
