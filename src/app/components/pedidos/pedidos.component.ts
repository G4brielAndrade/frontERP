...
export class PedidosComponent implements OnInit {
    ...
    readonly NFE_STEPS = [
        { labelKey: 'pedidos.nfe_steps.order', icon: 'pi-shopping-cart' },
        { labelKey: 'pedidos.nfe_steps.queue', icon: 'pi-list' },
        { labelKey: 'pedidos.nfe_steps.xml', icon: 'pi-code' },
        { labelKey: 'pedidos.nfe_steps.sefaz', icon: 'pi-cloud-upload' },
        { labelKey: 'pedidos.nfe_steps.authorized', icon: 'pi-check-circle' },
    ];
