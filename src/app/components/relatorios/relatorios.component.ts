...
export class RelatoriosComponent implements OnInit {
    ...
    readonly periodos: { value: PeriodoRelatorio; label: string }[] = [
        { value: '7d', label: 'relatorios.filters.period_7d' },
        { value: '30d', label: 'relatorios.filters.period_30d' },
        { value: '90d', label: 'relatorios.filters.period_90d' },
        { value: '12m', label: 'relatorios.filters.period_12m' },
        { value: 'personalizado', label: 'relatorios.filters.period_custom' },
    ];
